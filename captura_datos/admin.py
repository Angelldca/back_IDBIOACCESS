...
from .models import Dusuario, Dciudadano,Ncausaanulacion, Dciudadanobash, Dsolapin,Ntiposolapin, Dimagenfacial, Nestado, Dregistropago
...
admin.site.register(Ncausaanulacion)